                            ...
                            <div class="relative flex gap-4">
                                <div class="flex flex-1">
                                    <div class="h-10 w-10 rounded-full bg-white/90 p-0.5 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:ring-white/10">
                                        <a :aria-label="identity.name" class="pointer-events-auto" :href="identity.href">
                                            <img alt="" fetchpriority="high" width="64" height="64" decoding="async" data-nimg="1" class="rounded-full bg-zinc-100 object-cover dark:bg-zinc-800 h-9 w-9" sizes="2.25rem" :src="identity.img" style="color: transparent;" />
                                        </a>
                                    </div>
                                </div>
                                <slot />
                                <div class="flex justify-end md:flex-1">
                                    <div class="pointer-events-auto">
                                        <button type="button" aria-label="Switch to dark theme" class="group rounded-full bg-white/90 px-3 py-2 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur transition dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20">
...
<script setup>
const identity = { name: 'Home', href: '/', img: "img/avatar.jpg" }
</script>